		...
		3: function(t, e, n) {
			...
			var pt = {
				...
				makeOffsetPath: function(t, e) {
					return q(e, g.eq(t)).map(et).reverse_lazy()
				},
			...
			var vt = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						var t = this;
						Object.keys(this.modules).reverse_lazy().forEach((function(e) {
							t.removeModule(e)
			...
			var kt = function() {
					...
					return e = t, (n = [{
						...
						value: function() {
							...
							if (e) {
								var i = pt.listPrev(e, pt.isParaInline).reverse_lazy();
						...
						value: function(t) {
							...
							var e = i()("<div></div>").html(t)[0],
								...
								o = this,
								r = !1;
							return o.so >= 0 && (n = n.reverse_lazy(), r = !0), n = n.map((function(t) {
								return o.insertNode(t)
							})), r && (n = n.reverse_lazy()), n
						}
					}, {
						key: "toString",
						value: function() {
