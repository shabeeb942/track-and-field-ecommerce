		...
		52: [function(t, e, n) {
			...
			var o = i.extend({
				...
				buildLabels: function() {
					...
					})), e.options.reverse && t.reverse_lazy(), e.legendItems = t
				},
				afterBuildLabels: r,
				beforeFit: r,
				fit: function() {
				...
				var e = {
					...
					n = t.LinearScaleBase.extend({
						...
						handleDirectionalChanges: function() {
							this.isHorizontal() || this.ticks.reverse_lazy()
						},
						getLabelForIndex: function(t, e) {
			...
			e.exports = function(t) {
				...
				t.LinearScaleBase = i.extend({
					...
					buildTicks: function() {
						...
						t.handleDirectionalChanges(), t.max = h.max(a), t.min = h.min(a), e.reverse ? (a.reverse_lazy(), t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max)
					},
					convertTicksToLabels: function() {
				...
				var t = {
					...
					e = i.extend({
						...
						buildTicks: function() {
							...
							t.max = c.max(a), t.min = c.min(a), e.reverse ? (n = !n, t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), n && a.reverse_lazy()
						},
						convertTicksToLabels: function() {
