...
! function(t, e) {
	...
	var qe = K.extend({
			...
			handleEvent: function(t) {
				var e, n = this,
					i = n._options;
				return n._lastActive = n._lastActive || [], "mouseout" === t.type ? n._active = [] : (n._active = n._chart.getElementsAtEventForMode(t, i.mode, i), i.reverse && n._active.reverse_lazy()), (e = !H.arrayEquals(n._active, n._lastActive)) && (n._lastActive = n._active, (i.enabled || i.custom) && (n._eventPosition = {
					x: t.x,
					y: t.y
	...
	var zn = yn.extend({
			...
			buildTicks: function() {
				...
				t.max = H.max(a), t.min = H.min(a), e.reverse ? (n = !n, t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), n && a.reverse_lazy()
			},
			convertTicksToLabels: function() {
	...
	var hi = yn.extend({
			...
			buildTicks: function() {
				...
				}(i._table, d, 0, 0, o), s.reverse && d.reverse_lazy(), di(i, d, i._majorUnit)
			},
			getLabelForIndex: function(t, e) {
				var n = this,
					i = n._adapter,
	...
	var Ai = K.extend({
		...
		buildLabels: function() {
			...
			}))), t.options.reverse && n.reverse_lazy(), t.legendItems = n
		},
		afterBuildLabels: Si,
		beforeFit: Si,
		fit: function() {
