...
! function(t, e) {
	...
	var x = {
		...
		X = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					var l = t.slice();
					e.config.yaxis[0].reversed && (o = !0, l.reverse_lazy());
		...
		F = function() {
			...
			return a(t, [{
				...
				key: "drawPolygons",
				value: function(t) {
					for (var e = this, i = this.w, a = t.parent, s = i.globals.yAxisScale[0].result.reverse_lazy(), n = s.length, r = [], o = this.size / (n - 1), l = 0; l < n; l++) r[l] = o * l;
					r.reverse_lazy();
					var h = [],
						c = [];
		...
		H = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					if (e.config.yaxis[t] && e.config.yaxis[t].reversed && d.reverse_lazy(), e.config.yaxis[t].labels.show)
						for (var u = o; u >= 0; u--) {
							var g = d[u];
							g = c(g, u);
				...
				value: function(t) {
					...
					c.length > 0 && (this.xaxisLabels = c.slice(), n = (h = c.slice()).length), e.config.yaxis[t] && e.config.yaxis[t].reversed && h.reverse_lazy();
					var d = c.length;
	...
	nt = "undefined" != typeof window ? window : void 0, rt = function(e, i) {
			...
			a.did = 1e3, a.eid = function(t) {
				...
				reverse: function() {
					return this.value.reverse_lazy(), this
				},
				clone: function() {
